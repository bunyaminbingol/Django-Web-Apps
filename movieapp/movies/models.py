...
class Person(models.Model):
    ...
    @property # property: oluşturulan fonksiyonun çalıştırılmasını sağlar.
    def full_name(self):
...
class Comment(models.Model):
    ...
    date_added = models.DateField(null=True, auto_now=True)
    movie = models.ForeignKey(Movie, on_delete=models.CASCADE, related_name="comments") # related_name: ilişkili modelin ismi.
